...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'has_end_date' => 'لدية تاريخ اننهاء',
        ...
        'product_id' => 'المنتج',
        'start' => 'البداية',
        'opening_quantity' => 'الكمية الأفتتاحية',
        'end' => 'النهاية',
        'rate' => 'النسبة',
        'content' => 'المُحتوى',
        'description' => 'الوصف',
        ...
        'loading_location.lat' => 'موقع الشحن',
        'individual' => 'فرد',
        'shipment_type_id' => 'نوع الشحنه',
        'type' => 'النوع',
        ...
        'client_id' => 'العميل',
        'rest' => 'المتبقي',
        'user_category_id' => 'قسم الموظف',
        'branch_id' => 'الفرع',
        'items' => 'المنتجات',
        'payments' => 'المدفوعات',

        'payments.*.payment_method_id' => 'طريقة الدفع',
        'payments.*.amount' => 'المبلغ المدفوع',
        'amount' => 'المبلغ',
        'expense_category_id' => 'القسم',
