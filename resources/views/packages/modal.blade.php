    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ $name?'تعديل':'إضافة' }} {{ __('site.Packages') }}</h5>
            ...
            <div class="modal-body">
                <div class="row row-gap-24">
                    ...
                    <div class=" col-sm-4">
                        <label class="small-label" for="">{{ __('site.rate') }}</label>
                        <input class="form-control" type="number" min="0" wire:model.defer='rate' placeholder="">
                    </div>
                </div>
            </div>
